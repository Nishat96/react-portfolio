    ...
    return (
        ...
        <div className="row about-row">
            <div className="col-md-7">
                <p> I am Nishat Tasnim Mithila, who completed her graduation in this year from <span className="varsity">Daffodil International University</span> , CSE Department. </p>
                I have done a Web Development course from Programming Hero. It was a great journey. Through this course I have got my skill at:
            ...
            <div className="col-md-4">
                ...
                <ul>
                    ...
                    <li> <span className="varsity"> Web Development Skills: </span> Html5, Css3, Bootstrap4, Es6, React.js, React-routing, React-hooks, Context-API, Firebase-auth </li>
